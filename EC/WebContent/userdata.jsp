...
<%
	...
	ArrayList<BuyDataBeans> itemList = (ArrayList<BuyDataBeans>) request.getAttribute("itemList");
%>
</head>
<body>
				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<%
								for (BuyDataBeans item : itemList) {
							%>
							<tbody>
								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?buy_id=<%=item.getBuyId()%>" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
